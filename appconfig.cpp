...
stc_webconfig_description_t astcAppConfigDescription[] = {
    ...
    {enWebConfigTypeUInt32,"PosStart","Start"},
    {enWebConfigTypeUInt32,"PosKerze1","Kerze1"},
    {enWebConfigTypeUInt32,"PosKerze2","Kerze2"},
    {enWebConfigTypeUInt32,"PosKerze3","Kerze3"},
    {enWebConfigTypeUInt32,"PosKerze4","Kerze4"},
...
#endif
{
  if (bInitDone == false)
  {
    ...
    if (stcAppConfig.u32magic != 0xCFDFAABB)
    {
      ...
      AppConfig_SetPosStart(500);
      AppConfig_SetPosKerze1(1000);
      AppConfig_SetPosKerze2(1500);
      AppConfig_SetPosKerze3(2200);
      AppConfig_SetPosKerze4(2700);
 ...
 **********************************************
 */
uint32_t AppConfig_GetPosStart(void)
{
  if (bInitDone == false)
  {
    AppConfig_Init(NULL);
  }
  return stcAppConfig.PosStart;
}
 ...
 ********************************************* 
 */
void AppConfig_SetPosStart(uint32_t PosStart)
{
  if (bInitDone == false)
  {
    AppConfig_Init(NULL);
  }
  stcAppConfig.PosStart = PosStart;
  AppConfig_Write();
}
/**********************************************
 * Get PosKerze1 - Kerze1
 * 
 * \return PosKerze1
 **********************************************
 */
uint32_t AppConfig_GetPosKerze1(void)
{
  if (bInitDone == false)
  {
    AppConfig_Init(NULL);
  }
  return stcAppConfig.PosKerze1;
}

/*********************************************
 * Set PosKerze1 - Kerze1
 * 
 * \param PosKerze1 Kerze1
 * 
 ********************************************* 
 */
void AppConfig_SetPosKerze1(uint32_t PosKerze1)
{
  if (bInitDone == false)
  {
    AppConfig_Init(NULL);
  }
  stcAppConfig.PosKerze1 = PosKerze1;
  AppConfig_Write();
}
/**********************************************
 * Get PosKerze2 - Kerze2
 * 
 * \return PosKerze2
 **********************************************
 */
uint32_t AppConfig_GetPosKerze2(void)
{
  if (bInitDone == false)
  {
    AppConfig_Init(NULL);
  }
  return stcAppConfig.PosKerze2;
}

/*********************************************
 * Set PosKerze2 - Kerze2
 * 
 * \param PosKerze2 Kerze2
 * 
 ********************************************* 
 */
void AppConfig_SetPosKerze2(uint32_t PosKerze2)
{
  if (bInitDone == false)
  {
    AppConfig_Init(NULL);
  }
  stcAppConfig.PosKerze2 = PosKerze2;
  AppConfig_Write();
}
/**********************************************
 * Get PosKerze3 - Kerze3
 * 
 * \return PosKerze3
 **********************************************
 */
uint32_t AppConfig_GetPosKerze3(void)
{
  if (bInitDone == false)
  {
    AppConfig_Init(NULL);
  }
  return stcAppConfig.PosKerze3;
}

/*********************************************
 * Set PosKerze3 - Kerze3
 * 
 * \param PosKerze3 Kerze3
 * 
 ********************************************* 
 */
void AppConfig_SetPosKerze3(uint32_t PosKerze3)
{
  if (bInitDone == false)
  {
    AppConfig_Init(NULL);
  }
  stcAppConfig.PosKerze3 = PosKerze3;
  AppConfig_Write();
}
/**********************************************
 * Get PosKerze4 - Kerze4
 * 
 * \return PosKerze4
 **********************************************
 */
uint32_t AppConfig_GetPosKerze4(void)
{
  if (bInitDone == false)
  {
    AppConfig_Init(NULL);
  }
  return stcAppConfig.PosKerze4;
}

/*********************************************
 * Set PosKerze4 - Kerze4
 * 
 * \param PosKerze4 Kerze4
 * 
 ********************************************* 
 */
void AppConfig_SetPosKerze4(uint32_t PosKerze4)
{
  if (bInitDone == false)
  {
    AppConfig_Init(NULL);
  }
  stcAppConfig.PosKerze4 = PosKerze4;
  AppConfig_Write();
}
